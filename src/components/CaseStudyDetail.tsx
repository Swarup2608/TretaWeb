            ...
            <section className="py-16 sm:py-20 lg:py-24 bg-light">
                <div className="container mx-auto px-4">
                    <div className="max-w-4xl mx-auto">
                        ...
                        >
                            {caseStudy.labels.split(',').map((label, idx) => (
                                <span
                                    key={idx}
                                    className="px-4 py-2 text-sm font-medium text-background bg-primary rounded-full"
                                >
                                    {label.trim()}
                                </span>
                            ))}
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    ...
                                    {/* Button content */}
                                    <span className="relative z-10">{caseStudy.button}</span>
