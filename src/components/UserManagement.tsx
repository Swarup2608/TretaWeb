...
export default function UserManagement() {
    ...
    if (user?.role !== 'superadmin') {
        return (
            <div className={`rounded-xl p-6 shadow-lg ${theme === 'dark' ? 'bg-linear-to-r from-yellow-900/30 to-orange-900/30 border-2 border-yellow-600' : 'bg-linear-to-r from-yellow-50 to-orange-50 border-2 border-yellow-200'}`}>
